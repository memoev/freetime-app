	...
	var e = (function() {
		function u() {
			...
			(this.escapeRegExp = function(t) {
				...
				(this.minLength = 0 < parseInt(e, 10) ? e : 0),
				(this.salt = "string" == typeof t ? t : ""),
				"string" == typeof s && (this.alphabet = s);
			for (var r = 0; r !== this.alphabet.length; r++)
				-1 === n.indexOf(this.alphabet.charAt(r)) &&
					(n += this.alphabet.charAt(r));
			...
			for (var i = 0; i !== this.seps.length; i++) {
				...
				-1 === l
					...
					: (this.alphabet =
							this.alphabet.substr(0, l) + " " + this.alphabet.substr(l + 1));
			}
			(this.alphabet = this.alphabet.replace(/ /g, "")),
				(this.seps = this.seps.replace(/ /g, "")),
				(this.seps = this._shuffle(this.seps, this.salt)),
				(!this.seps.length || 3.5 < this.alphabet.length / this.seps.length) &&
					(h = Math.ceil(this.alphabet.length / 3.5)) > this.seps.length &&
					((a = h - this.seps.length),
					(this.seps += this.alphabet.substr(0, a)),
					(this.alphabet = this.alphabet.substr(a))),
				(this.alphabet = this._shuffle(this.alphabet, this.salt));
			var p = Math.ceil(this.alphabet.length / 12);
			this.alphabet.length < 3
				? ((this.guards = this.seps.substr(0, p)),
				  (this.seps = this.seps.substr(p)))
				: ((this.guards = this.alphabet.substr(0, p)),
			...
			(e = [
				{
					...
					value: function() {
						for (var t = arguments.length, e = new Array(t), s = 0; s < t; s++)
							e[s] = arguments[s];
						if (!e.length) return "";
						if (e[0] && e[0].constructor === Array && !(e = e[0]).length)
							return "";
				...
				},
				{
					...
					value: function(t) {
						for (var e, s = this.alphabet, h = 0, a = 0; a !== t.length; a++)
							h += t[a] % (a + 100);
						for (
							var n = (e = s.charAt(h % s.length)), r = 0;
							r !== t.length;
							r++
						) {
							var i = t[r],
						...
						if (e.length < this.minLength) {
							var o = (h + e[0].charCodeAt(0)) % this.guards.length,
								f = this.guards[o];
							(e = f + e).length < this.minLength &&
								((o = (h + e[2].charCodeAt(0)) % this.guards.length),
								(e += f = this.guards[o]));
						}
						for (
							var c = parseInt(s.length / 2, 10);
							e.length < this.minLength;

						) {
							var g =
								(e = (s = this._shuffle(s, s)).substr(c) + e + s.substr(0, c))
					...
					value: function(t, e) {
						...
						if (
							...
							(n = n.substr(1)),
								...
								(r = (n = n.replace(a, " ")).split(" "));
							for (var l = 0; l !== r.length; l++) {
								var p = r[l],
									u = i + this.salt + e;
								(e = this._shuffle(e, u.substr(0, e.length))),
									s.push(this._fromAlphabet(p, e));
							}
							this.encode(s) !== t && (s = []);
						}
						return s;
				...
				},
				{
					...
					value: function(t, e) {
						...
						for (
							var h = (t = t.split("")).length - 1, a = 0, n = 0, r = 0;
							0 < h;
							h--, a++
						) {
